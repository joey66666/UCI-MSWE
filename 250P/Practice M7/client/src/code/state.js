...
function createState(inParentComponent) {
    return {
        ...
        showComposeMessage: function (inType) {
            ...
            switch (inType) {
                case "new":
                    ...
                    console.log(config_1.config.userEmail);
                    break;
                case "reply":
                    this.setState({
                        currentView: "compose",
        ...
        sendMessage: function () {
            return __awaiter(this, void 0, void 0, function* () {
                console.log("sendMessage()", this.state.messageTo, this.state.messageFrom, this.state.messageSubject, this.state.messageBody);
                this.state.showHidePleaseWait(true);
